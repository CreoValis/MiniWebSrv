...
enum HEADERNAME
{
	...
	HN_ACCESS_CONTROL_REQUEST_METHOD,
	HN_ACCESS_CONTROL_REQUEST_HEADERS,
...
struct Header
{
	...
	void ParseContentDisposition(std::string &OutName, std::string &OutFileName, bool &OutFileNameExists) const;
